...
import { WildseaActor } from './documents/actor.mjs';
import { WildseaItem } from './documents/item.mjs';
...
Hooks.once('init', function () {
  ...
  Actors.registerSheet('wildsea', WildseaActorSheet, {
    makeDefault: true,
    label: 'WILDSEA.SheetLabels.Actor',
  });
  Items.unregisterSheet('core', ItemSheet);
  Items.registerSheet('wildsea', WildseaItemSheet, {
    makeDefault: true,
    label: 'WILDSEA.SheetLabels.Item',
  });
...
async function createItemMacro(data, slot) {
  ...
  const command = `game.wildsea.rollItemMacro("${data.uuid}");`;
